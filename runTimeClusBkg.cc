...
int main (int argc, char ** argv) {
  ...
  while ( mixer.next_event() && iev < nEvent )
  {
    ...
    sdcCS.setRecursiveAlgo(3);//0 = CA 1 = AKT 2 = KT  3=gen_kt t-form ordered
    ...
    sdcCSzcut.setRecursiveAlgo(3);//0 = CA 1 = AKT 2 = KT  3=gen_kt t-form ordered
    ...
    sdcCSFull.setRecursiveAlgo(3);//0 = CA 1 = AKT 2 = KT  3=gen_kt t-form ordered
    ...
    sdcCSFullzcut.setRecursiveAlgo(3);//0 = CA 1 = AKT 2 = KT  3=gen_kt t-form ordered
